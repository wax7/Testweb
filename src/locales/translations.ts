...
export const translations: Record<Language, Translation> = {
  ...
  es: {
    ...
    features: {
      ...
      quickMute: {
        title: 'Silenciamento Rápido',
        description: 'Botões de mute com um clique para cada app. Sem menus. Sem teclas de atalho complicadas. Apenas controle instantâneo.',
      },
      focusMode: {
        title: 'Modo Foco',
        description: 'Mute tudo exceto as apps que você precisa. Perfeito para trabalho profundo, reuniões ou sessões de estudo concentrado.',
      },
      audioProfiles: {
        title: 'Perfis de Áudio Inteligentes',
        description: 'Alterne entre configurações de áudio predefinidas em segundos. Trabalho, Jogos, Música, Chamadas—configure uma vez, reutilize para sempre.',
      },
      keyboardShortcuts: {
        title: 'Atalhos de Teclado Poderosos',
        description: 'Controle tudo sem tocar no mouse. Atalhos personalizáveis para cada ação.',
      },
      nativeDesign: {
        title: 'Design Native do macOS',
        description: 'Parece que sempre fez parte do seu Mac. Construído com SwiftUI, otimizado para velocidade e interface nativa.',
      },
      magicBoost: {
        title: 'Magic Boost',
        description: 'Aumento de volume acima de 100% quando necessário. Áudio baixo em reuniões? Vá além do limite sem sacrificar a qualidade.',
      },
    },
    useCases: {
      title: 'Quem Usa MACA?',
      designerTitle: 'Designers & Criadores',
      designer: 'Spotify tocando, Adobe aberto, videoconferências em standby. Níveis de áudio perfeitos sem irritação.',
      producerTitle: 'Produtores & Músicos',
      producer: 'DAW a 80%, samples a 70%, referências a 60%. Controle total para mixar e produzir sem distração.',
      developerTitle: 'Desenvolvedores & Programadores',
      developer: 'Música para foco, Stack Overflow aberto, notificações silenciadas. Codifique com o fundo musical perfeito.',
      remoteTitle: 'Trabalhadores Remotos',
      remote: 'Zoom a 100%, músic a a 30%, notificações a 0%. Reuniões sem interrupções.',
    },
    allDevices: {
      title: 'Um Sistema. Todos os Dispositivos.',
      subtitle: 'MACA se conecta perfeitamente a todos os seus dispositivos de áudio. Sejam fones de ouvido, caixas de som, monitores ou AirPods—controle total sobre cada dispositivo.',
